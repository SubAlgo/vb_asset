	...
	this.init= function(){
        ...
        $('.form-datetime').bootstrapMaterialDatePicker({
           ...
           minDate: moment().format('YYYY-MM-DD 00:00'),
			//minDate: moment().format('DD-MM-YYYY 00:00'),
    ...
    this.Editor = function(){
        ...
        $('.dialog-upload').click(function() {
            ...
            var fm = $('<div/>').dialogelfinder({
                ...
                width : ($(window).width() > 640)?640:$(window).width() - 30,
            ...
            if(!_form.hasClass('disable')){
                ...
                $.post(_action, _data, function(result){
                    ...
                    if(result['st'] == "success"){
                        ...
                        window.open(result['url'],'winname','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=700,height=600');
